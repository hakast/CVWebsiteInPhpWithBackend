...
if (isset($_POST['save'])) {
	//Har submitknappen med namn "save" klickats?
	$columnText = $_POST["colbakgrund"];
	//I	så fall spara colutbildning i variabel
	mysqli_query($connection, "UPDATE tablebakgrund 
        SET colbakgrund = '$columnText' WHERE id=1");
	//U	ppdatera databasens kolumn med det 
}
